...
const translations = {
  en: {
    ...
    man: "Man", king: "King", understandContinue: "I understand, continue", finishExercise: "Finish this exercise",
  ...
  zh: {
    ...
    man: "兵", king: "王棋", understandContinue: "明白，继续学习", finishExercise: "完成本节练习",
