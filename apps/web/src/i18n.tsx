...
const translations = {
  en: {
    ...
    learnKingCaptureBody: "A king captures along diagonals and can land beyond the captured piece when the landing square is open.",
    learnVictoryBody: "You win when your opponent has no legal move, no pieces left, resigns, or loses on time.",
    man: "Man", king: "King", victory: "Victory!", allOpponentPiecesCaptured: "All opponent pieces are captured", playAnimation: "Play animation", refreshAnimation: "Replay animation",
  ...
  zh: {
    ...
    learnKingCaptureBody: "王棋沿斜线吃子，并可落在被吃棋子后方的空格。",
    learnVictoryBody: "当对手无棋可走、棋子被吃光、认输或超时时，即可获胜。",
