...
const translations = {
  en: {
    ...
    registerKeepsGuestHistory: "If you have played as a guest in this browser, registration keeps that identity and future history together.",
  ...
  zh: {
    ...
    registerKeepsGuestHistory: "如果你已在此浏览器以访客身份对局，注册后会保留同一个身份并继续积累数据。",
