...
const translations = {
  en: {
    ...
    navLearn: "Learn", navTrain: "Train", navClassroom: "Class", navPlay: "Play", navAi: "AI",
    rating: "{value} rating",
    learnKicker: "Learning center", learnTitle: "Learning Path", learnSubtitle: "Short lessons, daily drills, then a real board.",
  ...
  zh: {
    ...
    navLearn: "学习", navTrain: "训练", navClassroom: "课堂", navPlay: "对弈", navAi: "AI",
    rating: "等级分 {value}",
    learnKicker: "学习中心", learnTitle: "学习路径", learnSubtitle: "短课、每日训练，然后上棋盘实战。",
