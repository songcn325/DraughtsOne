...
const translations = {
  en: {
    ...
    learnKingCaptureBody: "A king can jump over opponent pieces along a diagonal and choose its landing square. If several captures are available, the route that captures the most pieces must be played.",
  ...
  zh: {
    ...
    learnKingCaptureBody: "王可在斜向上跳过对方棋子吃子，落点可选；有多个可吃棋子时，必须选择吃子最多的路径。",
